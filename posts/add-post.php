        ...
        <div id="page-wrapper">
            <div class="container-fluid container-fluid-mine effect8 padding-mine">
                <form action="" method="POST" id="post-question-form">
                    <div>
                        <h3>Laporan Resah</h3>
                        <input type="text" name="question_tags" id="question_tags" class="form-control" autocomplete="off" placeholder="Isikan Keresahan Anda">
                        <br>
                        <div class="form-group shadow-textarea-mine">
                            <textarea id="askedQuestion" class="form-control z-depth-1-mine" rows="5" placeholder="Jelaskan detail Keresahan Anda"></textarea>
                        </div>

...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0;">
            ...
            <ul class="nav navbar-top-links navbar-right">
                    <button style="background: none; color: inherit; border: none; padding: 0; font: inherit; outline: inherit; padding-left: 22px; margin-top:14px; margin-right: 10px;">
                    <a href="http://localhost/laporResah-main/logout.php"><i class="fa fa-sign-out fa-fw"></i> Logout</button></a>
                <!-- /.dropdown -->
            </ul>
            <!-- /.navbar-top-links -->
